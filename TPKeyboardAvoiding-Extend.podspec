Pod::Spec.new do |s|
  s.name     = 'TPKeyboardAvoiding-Extend'
  s.version  = '1.3.1.1'
  s.license  = 'zlib'
  s.platform = :ios
  s.summary  = 'A drop-in universal solution for moving text fields out of the way of the keyboard in iOS.'
  s.homepage = 'https://github.com/diong/TPKeyboardAvoiding'
  s.author   = { 'Michael Tyson' => 'michael@atastypixel.com' }
  s.source   = { :git => 'https://github.com/diong/TPKeyboardAvoiding.git', :tag => '1.3.1.1' }
